...
// The "Currently … at …" line shared by the landing hero and the password
// gate. Colour and size are inherited, so each caller styles it via the
// wrapping element (left-aligned on the landing hero, centred on the gate).
  ...
  return (
    <span className={`text-left leading-[1.8] ${className}`}>
      <span>
        ...
        <span className="[letter-spacing:0.2em]">
