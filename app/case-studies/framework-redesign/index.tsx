  ...
  return (
    <article className="prose max-w-none">
      <section className="mb-12">
        <p>
          This is one slice of a larger design system project at
          WiseTech Global. The broader project ran several parallel threads: an identity
          refresh, a system-wide rethink, and a deeper investment in expert
          workflows. This summary focuses on the part I played a leading role in: <strong>the product shell.</strong>
        </p>
        <p>
          The shell is the scaffolding around WiseTech's flagship logistics product. It comprises:
        </p>
        <ul>
        ...
        <p>
          The shell had previously been built following standard web patterns: lightweight,
          familiar, the kind of chrome shaped for consumer-grade software.
        </p>
        <p>
          But WiseTech's users are different. They're logistics experts running
          ...
          friction compounded across every workflow. Before we could fix it, we
          needed to understand what was getting in their way and what had to
          change to make the shell work better for them.
        </p>
        ...
        <p>
          The synthesis became a valuable asset that shaped the shell work
          directly, and fed into the broader system rethink running in parallel.
        </p>
        <Image
        ...
        <p>
          The redesigned shell brings together a highly configurable side navigation, a
          clearer hierarchy in the page chrome, calculated use of colour,
          and content layouts that flex with the work. <strong>It doesn't shy away from
          density where expert workflows demand it.</strong> Controls aren't buried or
          hidden behind menus; they're surfaced and within reach, with the
          whole shell tuned for speed.
        </p>
        <Image
        ...
        <p>
          ...
          and the synthesis itself became a reference point teams returned to time and again.
        </p>
        <p>
          The shell was deceptively complex. What reads as a few large patterns
          was really dozens of interconnected, overlapping features, states, and
          behaviours. So for much of the UI work, I adopted an
          AI-enabled workflow that balanced the Figma canvas with a coded
          prototyping environment. I set up a <strong>dedicated playground repo where
          decisions could move in and out of Figma</strong> as the design progressed:
          sketching on the canvas, prototyping in code, bringing learnings back
          as designs took shape.
        </p>
        <p>Working somewhere dynamic and stateful meant I
          could explore visual direction, interaction, and responsive behaviour at the same
          time.</p>
      </section>
    </article>
  );
