    ...
    <article className="prose max-w-none">
      <section className="mb-12">
        ...
        <p>
          ...
          kind to a working, interactive UI prototype, without writing the code.
        ...
        <p>
          ...
          through those layers. Each one guides the AI through a specific task:
        ...
        <p>
          ...
          lead. The work was making sure its components and patterns could be
        ...
        <p>
          ...
          comes with legacy constraints, so there have been plenty of bumps to
